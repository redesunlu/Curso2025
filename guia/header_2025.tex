...
% permitir definir colores y usar resaltado de sintaxis
% mediante fenced code blocks estilo ```bash o ```python
% este usepackage fue funciona en Debian Buster, Ubuntu 18.04 y 20.04
...
\rhead{\textbf{
  Lic. en Sistemas de Información, UNLu\\
